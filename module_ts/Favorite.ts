class Favorite extends CommentSystem {
    ...
    public addListenerCommentsFavoritesBtns(commentID: number) {
        ...
        if(commentBlockEl) {
            const favoritesBtn: HTMLElement | null = commentBlockEl.querySelector('.comments__btnSelected')
    ...
    public addListenerReplyFavoritesBtns(commentID: number, replyID: number) {
        ...
        if(commentBlockEl) {
            ...
            if(replyEl) {
                const favoritesBtn: HTMLElement | null = replyEl.querySelector('.comments__btnSelected')
