class Dropdown extends CommentSystem {
    ...
    constructor(commentsObj: Comments) {
        ...
        this.filterDropdown = this.commentSystemFilter !== null ? this.commentSystemFilter.querySelector('.dropdown__filter') : null
        this.filterSelected = this.filterDropdown !== null ? this.filterDropdown.querySelector('.dropdown__span') : null
        this.filterList = this.filterDropdown !== null ? this.filterDropdown.querySelector('.dropdown__list') : null
        this.filterItems = this.filterDropdown !== null ? this.filterDropdown.querySelectorAll('.dropdown__item') : null
        this.filterFavorites = this.commentSystemFilter !== null ? this.commentSystemFilter.querySelector('.filter__favorite') : null
    ...
    private filterDirectionListener() {
        const filterDirectionBtn: HTMLElement | null = this.filterDropdown !== null ? this.filterDropdown.querySelector('.dropdown__btn') : null
    ...
    private favoritesCommentFilter() {
        const listener = (event: any) => {
            event.target.classList.toggle('filter__favorite_active')
            if(event.target.classList.contains('filter__favorite_active')) {
