class Answer extends CommentSystem {
    ...
    constructor(userForm: Forma, rating: Rating, favorites: Favorite) {
        super()
        ...
        if(commentBlock) {
            ...
            const btnReplyListener = (event: Event) => {
                if (event.target === replyBtn) {
                    ...
                    this.preNickname = commentBlock.querySelector('.comments__name')?.innerHTML
    ...
    public createReplyes(replyText:string) { 
