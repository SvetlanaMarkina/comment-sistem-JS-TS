class Rating extends CommentSystem {
    ...
    public addListenerCommentsRatingBtns(commentID: number) {
        ...
        if(commentBlockEl) {
            const ratingBtnBlock: HTMLElement | null = commentBlockEl.querySelector('.comments__rating')
    ...
    public addListenerReplyRatingBtns(commentID: number, replyID: number) {
        ...
        if(commentBlockEl) {
            ...
            if(replyEl) {
                const ratingBtnBlock: HTMLElement | null = replyEl.querySelector('.comments__rating')
